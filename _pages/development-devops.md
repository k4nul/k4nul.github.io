...
- Jenkins: [Jenkins는 무엇이고 왜 아직도 많이 쓰이는가](/devops/jenkins-what-and-why-still-used/), [Jenkins 설치와 초기 설정](/devops/jenkins-installation-initial-setup/), [플러그인, credentials, tools를 어떻게 관리해야 하는가](/devops/jenkins-plugins-credentials-tools-management/). Pipeline, Jenkinsfile, 장애 분리는 공개 후 순차 반영
