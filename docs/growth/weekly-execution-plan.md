...
## Next Operating Week: 2026-06-01~2026-06-07

목표: 다음 7일 예약 큐를 작은 일일 작업으로 나눠 운영하고, 실제 공개 전후 검증 포인트를 미리 고정한다.

- 월요일 2026-06-01: `Jenkins 08~10`, `K8S 01~04` KR/EN pair의 title, description, TL;DR, 허브 연결 후보, future-link 안전성을 점검한다.
- 화요일 2026-06-02: `Jenkins 09` KR/EN pair를 리라이트 후보로 우선 처리한다. 실패 유형, 원인 분리, 운영 관찰 포인트가 제목과 첫 문단에 드러나는지 본다.
- 수요일 2026-06-03: `2026-06-16 agent trace`와 `2026-06-23 guardrails` 예약 글이 연결할 템플릿 또는 체크리스트 1개만 보강 후보로 검토한다.
