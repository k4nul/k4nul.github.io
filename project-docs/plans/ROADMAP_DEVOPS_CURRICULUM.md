...
- 현재 상태: Docker 01~05, Git 01~08, Jenkins 01~10, K8S 01~10 포스트를 `_posts/`에 반영했다. Docker 01~05는 2026-04-21부터 2026-04-25까지 같은 주제의 KOR/ENG 번역 쌍을 동일 날짜에 발행한다. Git 01~08은 2026-05-17부터 2026-05-24까지, Jenkins 01~10은 2026-05-25부터 2026-06-03까지, K8S 01~10은 2026-06-04부터 2026-06-13까지 주제별 KOR/ENG를 같은 날짜에 발행하도록 재조정했다. 다만 `_data/section_topics.yml`과 `_pages/`에는 아직 `devops` 허브 메타데이터를 추가하지 않았다.
